<div class="content-wrapper">
  ...
  <section class="content">
    <a href="<?php echo base_url().'dashboard/donasi'; ?>" class="btn btn-sm btn-primary">Kembali</a>
    <br/>
    <br/>
      <form method="post" action="<?php echo base_url('dashboard/donasi_update') ?>" enctype="multipart/form-data">
        <div class="row">
          <div class="col-lg-6">
