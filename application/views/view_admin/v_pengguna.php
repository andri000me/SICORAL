                  ...
                  foreach($pengguna as $p){
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?php echo base_url().'dashboard/pengguna_hapus/'.$p->pengguna_id; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Data Akan Dihapus Apakah Anda Yakin?')"> <i class="fa fa-trash"></i> </a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
